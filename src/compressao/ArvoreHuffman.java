...
public class ArvoreHuffman {
	...
	/**
     * Retorna uma tabela de Huffman formatada para visualização.
     * @return String representando a tabela de Huffman.
     */
	public String getTabelaHuffman() {
		String tabela = "";
		for(Map.Entry<Character, String> entrada : tabelaHuffman.entrySet()) {
			tabela += "Caractere " + entrada.getKey() + " -- " + entrada.getValue() + "\n";
		}
		return tabela;
	}
}
